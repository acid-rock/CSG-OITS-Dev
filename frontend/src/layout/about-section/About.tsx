      ...
      <div className="about-layout">
        ...
        <div className="about-section-head">
          ...
          <p className="about-subheading">
            The Central Student Government of Cavite State University – Imus Campus.
            Committed to transparency, service, and genuine leadership for every kabsuhenyo.
          </p>
        </div>
        ...
        <div className="about-two-col">
          ...
          <div className="about-text-col">
            <span className="section-label about-kicker" style={{ textAlign: "left" }}>
            ...
            <blockquote className="about-blockquote">
              ...
              <p className="about-blockquote-text">
                Para sa kabsuhenyo,{" "}
                <span className="about-blockquote-highlight">puso</span>{" "}
            ...
            <p className="about-body-text">
              ...
              the true needs and aspirations of every kabsuhenyo. Our promise
              is simple yet powerful: to bring empathy, dedication, and true
              care to the forefront of our work. Our mission is to lead not
