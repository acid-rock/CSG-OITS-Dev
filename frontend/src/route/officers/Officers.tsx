...
function OCard({
  ...
  const initials = getInitials(
    officer.full_name,
  ); /* locked: full_name binding */
  const pos = Array.isArray(officer.position)
    ? officer.position[0]
    : officer.position;
    ...
    <div className="oc-card card">
      ...
      {!isAdviser && (
        <a
          ...
          style={
            !officer.socials
              ? { opacity: 0.3, cursor: "default", pointerEvents: "none" }
              : undefined
          }
          onClick={(e) => {
            if (!officer.socials) e.preventDefault();
          }}
...
const Officers = () => {
  ...
  const officerTermOptions = [
    ...new Set(officers.map((o) => o.year_serving).filter(Boolean)),
  ]
    .sort()
    .reverse() as string[];
    ...
    <>
      <div className="op-page">
        ...
        <header className="op-header">
          <span className="section-label op-kicker">
        ...
        <div className="op-content">
            ...
            <div className="op-pres-wrap">
              <div className="op-pres-card card">
                ...
                <a
                  ...
                  onClick={(e) => {
                    if (!president.socials) e.preventDefault();
                  }}
                >
                  <FaFacebook size={16} />
                </a>
          ...
          {otherExecs.length > 0 && (
            <div className="op-group">
              <span className="section-label op-group-label">
                Executive Officers
              </span>
                ...
                {committees.map((c) => {
                  ...
                  return (
                    <div
                      ...
                      tabIndex={0}
                      onKeyDown={(e) =>
                        e.key === "Enter" && setSelectedCommittee(c)
                      }
                    >
      ...
      {selectedCommittee && (
        ...
        >
          ...
          >
            ...
            <h2 className="op-committee-modal-title">
            ...
            {(() => {
              const members = officers.filter(
                (o) => o.committee === selectedCommittee.id,
              );
