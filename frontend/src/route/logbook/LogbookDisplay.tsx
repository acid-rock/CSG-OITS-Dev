      ...
      <div className="kk-display">
        ...
        <div className="kk-display-inner">
          ...
          <div className="kk-display-qr-col">
            ...
            <div className="kk-qr-card">
              ...
              >
                <QRCode
                  ...
                  fgColor="#0f1729"
                />
                {/* Always-visible affordance — tells users the QR is tappable */}
                <div className="kk-qr-tap-badge" aria-hidden="true">
            ...
            {/* Hint sits outside the white card — renders on the dark background */}
