    ...
    (["active", "archived", "bin"] as const)
      ...
      .forEach((t) => {
        ...
        axios
          ...
          .then(({ data: r }) => {
            setCounts((p) => ({ ...p, [t]: (r as BulletinEntry[]).length }));
          })
          .catch(() => {});
      });
              ...
              <section className="ad-card">
                ...
                <div className="ad-table-foot">
                  <span className="ad-foot-count">
                    ...
                    of <strong>{filteredActive.length}</strong> announcements
                  </span>
                  {aTotalPages > 1 && (
