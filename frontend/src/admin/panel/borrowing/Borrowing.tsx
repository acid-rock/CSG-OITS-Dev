    ...
    >
      ...
      {initial && (
        <p style={{ fontSize: "0.8rem", color: "#6b7280", margin: 0 }}>
          Note: changing total units does not affect currently borrowed
          quantities.
        </p>
      )}
      ...
      {tab === "requests" && (
        <>
          ...
          {requestsLoading ? (
            ...
            <p style={{ padding: "0.5rem 1rem", color: "red" }}>
              {requestsError}
            </p>
          ) : (
            ...
            <div style={{ display: "flex", gap: "0.75rem", marginTop: "1rem" }}>
              <button
                ...
                style={{
                  flex: 1,
                  padding: "0.5rem",
                  background: confirmType === "approve" ? "#16a34a" : "#dc2626",
                  color: "#fff",
                  border: "none",
                  borderRadius: 6,
                  cursor: "pointer",
