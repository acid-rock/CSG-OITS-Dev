...
const Settings = () => {
  ...
  useEffect(() => {
    axios
      .get(`${API_URL}/officers/terms`, { withCredentials: true })
  ...
  const handleSaveTerm = async () => {
    ...
    try {
      await axios.post(
        `${API_URL}/settings/term`,
        { value: termSelect.trim() },
  ...
  return (
    <div className="settings-container">
      ...
      <div className="settings-content">
        ...
        {/* ── Admin Accounts ── */}
        <div
          className="addmin-whitelist-container"
          style={{
            marginTop: "1rem",
        ...
        >
          ...
          <div
            className="whitelist-table-wrapper"
                  ...
                  {adminAccounts.map((acct) => (
                    <tr key={acct.id} className="settings-table-row">
                      <td style={{ verticalAlign: "middle" }}>
                        <span className="email-data">{acct.email ?? "—"}</span>
                      </td>
                      <td style={{ verticalAlign: "middle" }}>
                        <span className="name-data">{acct.role}</span>
                      </td>
                      <td
                        style={{
                          verticalAlign: "middle",
        ...
        <div className="general-settings" style={{ marginTop: "1.5rem" }}>
          ...
          <div style={{ marginTop: "1rem" }}>
            ...
            >
              Change your admin account password below. You will remain logged
              in after saving.
            </p>
            <PasswordForm />
          </div>
