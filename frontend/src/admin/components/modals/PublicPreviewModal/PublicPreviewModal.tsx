    ...
    <div className="ppm-doc-wrapper">
      <div className="ppm-doc-card">
        ...
        <div className="ppm-doc-body">
          ...
          <h3 className="ppm-doc-name">
            {displayName || name || <em>Unnamed document</em>}
          </h3>
        ...
        <div className="ppm-doc-action">
          <button disabled className="ppm-doc-btn">
            View →
          </button>
        </div>
      </div>
        ...
        <div className="ppm-header">
          <div>
            ...
            <p className="ppm-subtitle">
              This is how students see this {typeLabel.toLowerCase()} on the
              website
            </p>
          </div>
          <button
